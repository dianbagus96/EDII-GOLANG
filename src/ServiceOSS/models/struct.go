...
type Object3 struct {
	...
	*/
	...
	Luas_tanah_bidang_usaha   string `json:"luas_tanah_bidang_usaha"`   //land_required
	...
	Nilai_mesing_peralatan    string `json:"nilai_mesin_peralatan"`     //machine_equip
