...
func InsertDmCompany(Object PPM) (err error) {
	...
	if num > 0 {
		...
		//INSERT
		sql := `INSERT INTO 
		tbldmcompany(company_id, legal_status, invest_status, name, npwp, prop, kab, kec, kel, address, rt, rw, zip_id, telp, email, pic_identity_no, pic_name, pic_address, pic_position, pic_telp, pic_email) 
		VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? )`
		res, err := o.Raw(sql, Object.PPM.IDPerusahaan, Object.PPM.Status_badan, Object.PPM.Status_modal, Object.PPM.Nama_perusahaan, Object.PPM.Npwp_perusahaan,
			Object.PPM.Prop_perusahaan, Object.PPM.Kab_perusahaan, Object.PPM.Kec_perusahaan, Object.PPM.Kel_perusahaan, Object.PPM.Alamat_perusahaan,
			Object.PPM.Rt_perusahaan, Object.PPM.Rw_perusahaan, Object.PPM.Kodepos_perusahaan, Object.PPM.Telp_perusahaan, Object.PPM.Email_perusahaan, Object.PPM.Npwp_pic, Object.PPM.Nama_pic, Object.PPM.Alamat_pic, Object.PPM.Jabatan_pic, Object.PPM.Telp_pic, Object.PPM.Email_pic).Exec()
